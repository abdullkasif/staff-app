...
export function QuizBuilder({ onSave, isSaving }) {
  ...
  const [isInitialized, setIsInitialized] = useState(false)
   const saveCalled = useRef(false) // prevent multiple triggers
 ...
 // In your QuizBuilder.jsx, update the handleSave function:

const handleSave = () => {
    console.log('📍 QuizBuilder: handleSave called')

    if (saveCalled.current) {
      console.log('📍 QuizBuilder: Save already triggered')
    ...
    onSave(quizData).finally(() => {
      // reset so retry is possible if error happens
